...
# send_all, send_all_json, and class Client from code privided in slides: 
# https://github.com/uofa-cmput404/cmput404-slides/blob/master/examples/WebSocketsExamples/chat.py
# by referencing these codes, I have totally understand these codes.
...
def read_ws(ws,client):
    ...
    # reference: https://sdiehl.github.io/gevent-tutorial/
    try:
        while True:
            message = ws.receive()
        ...
        print("There's error when trying to read")
